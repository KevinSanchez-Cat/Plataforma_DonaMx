                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 ">
                            <section>
                                <div class="card ">
                                    <div class="card-body">
                                        <h5 class="card-title">Noticias</span></h5>
                                        <c:choose>
                                            <c:when test="${not empty lstNoticias}">   
                                                <c:forEach var="noticia" items="${lstNoticias}">
                                                    <div class="news">
                                                        <div class="post-item clearfix">
                                                            <img src="assets/img/img_principal.jpg" alt="">
                                                            <h4><a href="#">${noticia.getTitulo()}</a></h4>
                                                            <p class="text-truncate">${noticia.getDetalle()}</p>
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                            </c:when>
                                            <c:otherwise>
                                                <br>
                                                <div class="alert alert-secondary">Sin noticias...</div>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                </div>
