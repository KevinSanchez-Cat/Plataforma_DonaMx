...
<template:templete_administrador title="Sistemas operativos">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#sistemasoperativos-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-cpu"></i><span>Sistemas operativos</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="sistemasoperativos-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="administrador?page=sistemas_operativos&accion=agregar" class="active">
                                <i class="bi bi-circle"></i><span>Agregar</span>
                            </a>
                        </li> 
                        <li>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Agregar sistema operativo</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Sistemas operativos</li>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST" class=" needs-validation" novalidate>
                            <div class="row">
                                <div class="col col-md-4 position-relative">
                                    <label for="validationTooltip02" class="form-label">Nombre del sistema operativo</label>
                                ...
                                <div class="col col-md-3 position-relative">
                                    <label for="validationTooltip02" class="form-label">Versión</label>
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" id="validationTooltip02" value="" required>
                                        <div class="valid-tooltip">
                                            Se mira bien!
