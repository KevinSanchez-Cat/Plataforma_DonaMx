...
<template:templete_administrador title="Equipos computacionales">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#equiposcomputacionales-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-laptop"></i><span>Equipos computacionales</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="equiposcomputacionales-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="administrador?page=equipos_computacionales&accion=consultar_remunerados" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar equipos computacionales remunerados</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Equipos computacionales</li>
                        <li class="breadcrumb-item active">Consultar remunerados</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
