...
<template:templete_administrador title="Paqueteria">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="paqueteria-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=paqueteria&accion=buscar_serial" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Buscar número de serie del paquete</h1>
                <nav>
                    <ol class="breadcrumb">
