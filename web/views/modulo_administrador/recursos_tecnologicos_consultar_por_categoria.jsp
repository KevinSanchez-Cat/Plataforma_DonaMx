...
<template:templete_administrador title="Recursos tecnologicos">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#recursos-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-menu-button-wide"></i><span>Recursos Tecnologicos</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="recursos-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="administrador?page=recursos_tecnologicos&accion=consultar_categoria" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar recursos tecnologicos por categoría</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Recursos tecnologicos</li>
                        <li class="breadcrumb-item active">Consultar por categoría</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
