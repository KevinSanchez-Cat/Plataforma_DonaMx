...
<template:templete_administrador title="Donaciones">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="donaciones-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=donaciones&accion=consultar_donatario" class="active">
                                <i class="bi bi-circle"></i><span>Consultar por donatario</span>
                            </a>
                        </li>
                        <li>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar donaciones por donatario</h1>
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Donaciones por donatario</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
