...
<template:templete_administrador title="Voluntarios">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="voluntarios-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=voluntarios&accion=lista_negra" class="active">
                                <i class="bi bi-circle"></i><span>Consultar lista negra</span>
                            </a>
                        </li>
                    </ul>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                <h1>Consultar lista negra de voluntarios</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Voluntarios</li>
                        <li class="breadcrumb-item active">Consultar lista negra</li>
                    </ol>
                </nav>
            </div>
