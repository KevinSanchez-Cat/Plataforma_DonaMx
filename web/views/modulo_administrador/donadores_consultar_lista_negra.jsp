...
<template:templete_administrador title="Donadores">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#organizaciones-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-building"></i><span>Donadores</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="organizaciones-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="administrador?page=donadores&accion=lista_negra" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar lista negra de donadores</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item">Donadores</li>
