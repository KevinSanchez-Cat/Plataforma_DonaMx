...
<template:templete_administrador title="Solicitudes">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#solicitudes-nav" data-bs-toggle="collapse" href="">
                    ...
                    <ul id="solicitudes-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=solicitudes&accion=consultar_donatario" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consular solicitudes por donatario</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Solicitudes</li>
                        <li class="breadcrumb-item active">Consultar por donatario</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
