...
<template:templete_administrador title="Localidades">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#localidades-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-pin"></i><span>Localidades</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="localidades-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="administrador?page=localidades&accion=consultar" class="active">
                                <i class="bi bi-circle"></i><span>Consultar</span>
                            </a>
                        </li>
                    </ul>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar localidades</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Localidad</li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                            ...
                            <form class="d-flex " style="margin: 5px">
                                <input class="form-control me-2" type="search" placeholder="Buscar " aria-label="Buscar por folio">
