...
<template:templete_administrador title="Sistemas operativos">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="sistemasoperativos-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=sistemas_operativos&accion=consultar" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar sistemas operativos</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Sistema operativo</li>
