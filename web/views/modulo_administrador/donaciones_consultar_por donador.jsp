...
<template:templete_administrador title="Donaciones">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="donaciones-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=donaciones&accion=consultar_donador" class="active">
                                <i class="bi bi-circle"></i><span>Consultar por donador</span>
                            </a>
                        </li>
                        <li>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar donaciones por donador</h1>
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Donaciones por donador</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
