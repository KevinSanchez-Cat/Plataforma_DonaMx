...
<template:templete_administrador title="Recursos tecnologicos">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="recursos-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=recursos_tecnologicos&accion=consultar_donador" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar recursos tecnologicos por donador</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="administrador">Incio</a></li>
                        <li class="breadcrumb-item ">Recursos tecnologicos</li>
                        <li class="breadcrumb-item active">Consultar por donador</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
