            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="localidades-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="administrador?page=localidades&accion=buscar" class="active">
                                <i class="bi bi-circle"></i><span>Buscar</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <form action="" method="POST" class=" needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6 position-relative">
                                    <label for="validationTooltip02" class="form-label">Nombre de la localidad</label>
