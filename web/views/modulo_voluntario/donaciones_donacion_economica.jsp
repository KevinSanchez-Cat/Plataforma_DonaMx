...
<template:templete_voluntario title="Donaciones">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="donaciones-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="voluntario?page=donaciones&accion=donacion_economica" class="active">
