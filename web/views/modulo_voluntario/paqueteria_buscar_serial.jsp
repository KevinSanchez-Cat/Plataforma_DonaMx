...
<template:templete_voluntario title="Paqueteria">
    <jsp:attribute name="content">
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">

                <li class="nav-item">
                    <a class="nav-link collapsed" href="voluntario">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-target="#paqueteria-nav" data-bs-toggle="collapse" href="">
                        <i class="bi bi-truck"></i><span>Paqueteria</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="paqueteria-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="voluntario?page=paqueteria&accion=buscar_serial" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Buscar número de serie</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="voluntario">Incio</a></li>
                        <li class="breadcrumb-item ">Paquetería</li>
                        <li class="breadcrumb-item active">Buscar no. de serie</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
