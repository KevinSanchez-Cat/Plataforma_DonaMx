...
<template:templete_voluntario title="Organizacion">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="organizaciones-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="voluntario?page=organizacion&accion=editar" class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Editar información de la organización</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="voluntario">Incio</a></li>
                        <li class="breadcrumb-item ">Organización</li>
