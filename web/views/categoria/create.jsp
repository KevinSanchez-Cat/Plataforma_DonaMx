<%-- 
    Document   : create
    Created on : 10/04/2022, 11:59:52 PM
    Author     : por_s
--%>
    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-target="#categorias-nav" data-bs-toggle="collapse" href="views/categoria/index.jsp">
                    ...
                    <ul id="categorias-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="views/categoria/create.jsp" class="active">
