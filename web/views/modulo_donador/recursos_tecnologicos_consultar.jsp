...
<template:templete_donador title="Recursos tecnologicos">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="recursos-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="donador?page=recursos_tecnologicos&accion=consultar" class="active">
                ...
                <li class="nav-item">
                    ...
                    <ul id="donaciones-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="donador?page=donaciones&accion=buscar" >
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar recursos tecnologicos</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="donador">Incio</a></li>
                        <li class="breadcrumb-item">Recurso tecnologico</li>
