...
<template:templete_donador title="Equipos computacionales">
    <jsp:attribute name="content">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="equiposcomputacionales-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="donador?page=equipos_computacionales&accion=consultar" class="active">
                                <i class="bi bi-circle"></i><span>Ver todos</span>
                            </a>
                        </li>
                    </ul>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>Consultar equipos computacionales</h1>
                <nav>
                    <ol class="breadcrumb">
